...
GOCARDLESS_KEY=84f35c2f1a8b81681f956274de048bb
...
test: fmt lint vet
	@echo "+ $@"
	@GOCARDLESS_KEY=$(GOCARDLESS_KEY) go test -v -tags "$(BUILDTAGS) cgo" $(shell go list ./... | grep -v vendor)
